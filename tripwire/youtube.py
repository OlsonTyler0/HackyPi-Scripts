...
try:
    ...
    time.sleep(1.7)
    keyboard_layout.write("powershell -w h Add-Type -AssemblyName *m.W*s.F*s;$w=[Windows.Forms.Cursor];$p=$w::Position.X;while(1){if($w::Position.X-ne$p){break}else{Sleep 3}};saps https://www.youtube.com/watch?v=xvFZjo5PgG0&pp=ygUJcmljayByb2xs;sleep 3;$o=New-Object -ComObject WScript.Shell;$o.SendKeys('f')")
    keyboard.send(Keycode.ENTER)
    time.sleep(1.2)
